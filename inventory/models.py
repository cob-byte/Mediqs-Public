...
class Medicine(models.Model):
    ...
    expiration_date = models.DateField(validators=[MinValueValidator(limit_value=timezone.localdate)])
    health_center = models.ForeignKey(Healthcenter_Information, on_delete=models.CASCADE, null=True, blank=True)
    ...
    dor = models.DateField(validators=[MinValueValidator(limit_value=timezone.localdate)])
...
class MedicalEquipment(models.Model):
    ...
    warranty = models.DateField(validators=[MinValueValidator(limit_value=timezone.localdate)])
