...
from .models import Doctor_Information, Staff, Appointment, Report, Prescription, Education, Experience, Specimen, Test,Prescription_medicine,Prescription_test, Doctor_review 
