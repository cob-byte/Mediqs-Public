...
fig.set_figheight(8)
fig.set_figwidth(12)
plt.savefig(f'static/forecasting/test/STL_{Dataset.columns[0]}.svg')
...
def STS_components(group, y):
    ...
    group_yearly_trend = ['Chikungunya', 'Typhoid Fever', 'Hepatitis A', 'Cholera', 'Leptospirosis', 'Influenza-like illness', 'Acute bloody diarrhea']
    group_AR1_MA1 = ['Covid-19', 'Dengue', 'Typhoid Fever', 'Measles']
    group_AR1 = ['AR', 'Cholera', 'Chikungunya', 'Leptospirosis', 'Influenza-like illness', 'Acute bloody diarrhea', 'Hepatitis A']
    components = []
    if group == 'Covid-19':
        components = [
